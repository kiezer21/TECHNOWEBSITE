...
<div class="header">Customer Information</div> 
  <div class="row">
    ...
    <div class="col-md-12">
        <div class="col-md-6">
            <label>First Name: <?php echo $res->FNAME; ?></label>
              <!--  <p>::</p> -->
             
             <!-- <p>::</p> -->
        </div>
        <div class="col-md-6">
               <label>Last Name: <?php echo $res->LNAME; ?> </label>
                <!--  <p>::</p> -->
        </div>
    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
          <label>Contact No.: +<?php echo $res->PHONE; ?></label>
           <!--  <p>::</p> -->
        </div>
    </div>
...
-->
     <div class="col-md-12"> 
        <div class="col-md-6">
           <label>Municipality: <?php echo $res->CITYADD; ?></label> 
        </div>
    </div>
