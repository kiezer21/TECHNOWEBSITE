...
<div class="modal-content">
	...
	<div class="row" style="margin:2%">
		<div class="col-md-6"><b>Name :</b> <?php echo $cur->FNAME . ' '.  $cur->LNAME ;?></div>
		<div class="col-md-6"><b>Address:</b>  <?php echo $cur->CUSHOMENUM . ' ' . $cur->STREETADD . ' ' .$cur->BRGYADD . ' ' . $cur->CITYADD . ' ' .$cur->PROVINCE . ' ' .$cur->COUNTRY; ?>
     </div>
	</div>
