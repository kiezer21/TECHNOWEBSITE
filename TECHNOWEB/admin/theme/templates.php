...
<link rel="shortcut icon" href="../images/acon.png">
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >KGB Shop Admin Panel</a>
            </div>
            <!-- /.navbar-header -->
...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <?php echo $_SESSION['U_NAME']; ?> <img title="" width="20px" height="20px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        ?>
                         <li>
                             <a href="<?php echo web_root; ?>admin/settings/index.php" ><i class="fa fa-list-alt fa-fw"></i>  Set Delivery Fee </a>
