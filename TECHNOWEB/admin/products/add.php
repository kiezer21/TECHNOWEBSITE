...
?> 
 ...
 <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Add New Product/Service</h1>
          </div>
          <!-- /.col-lg-12 -->
       </div> 
              ...
              <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "Owner Name" type="text" value="" required>
                      </div>
                    </div>
                  </div>  
