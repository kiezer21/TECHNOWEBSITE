                 ...
                 <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <input  type="hidden" name="SETTINGID"  value="<?php echo $set->SETTINGID ?>">
                            ...
                            "Location" type="text" value="<?php echo $set->PLACE ?>" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                            ...
                            "Delivery Price in ₱" type="number" value=" <?php echo $set->DELPRICE ?>" required>
                      </div>
                    </div>
                  </div>
          ...
          <!-- /.col-lg-12 -->
                 ...
                 <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                             <input class="form-control input-sm" id="PLACE" name="PLACE" placeholder=
                            "Location" type="text" value="" required>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                             <input class="form-control input-sm" id="DELPRICE" name="DELPRICE" placeholder=
                            "Delivery Price in ₱" type="number" value="" required>
                      </div>
                    </div>
                  </div>
